      ...
      <div className={`bg-[#1a1b23] rounded-lg border border-[#373A40] p-5 ${className}`}>
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-xs text-[#5c5f66] max-w-sm">
            .env.local에 GA_PROPERTY_ID, GOOGLE_CLIENT_EMAIL, GOOGLE_PRIVATE_KEY 환경 변수를 설정하세요
          </p>
          <a
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
          ...
          <div className="bg-[#25262b] rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              ...
              {metrics?.activeUsers.changePercent !== undefined && (
                <span className={`text-xs flex items-center gap-0.5 ${getTrendColor(metrics.activeUsers.changePercent)}`}>
          ...
          <div className="bg-[#25262b] rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              ...
              {metrics?.sessions.changePercent !== undefined && (
                <span className={`text-xs flex items-center gap-0.5 ${getTrendColor(metrics.sessions.changePercent)}`}>
          ...
          <div className="bg-[#25262b] rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              ...
              {metrics?.pageViews.changePercent !== undefined && (
                <span className={`text-xs flex items-center gap-0.5 ${getTrendColor(metrics.pageViews.changePercent)}`}>
          ...
          <div className="bg-[#25262b] rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              ...
              {metrics?.newUsers.changePercent !== undefined && (
                <span className={`text-xs flex items-center gap-0.5 ${getTrendColor(metrics.newUsers.changePercent)}`}>
          ...
          <div className="bg-[#25262b] rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              ...
              {metrics?.avgSessionDuration.changePercent !== undefined && (
                <span className={`text-xs flex items-center gap-0.5 ${getTrendColor(metrics.avgSessionDuration.changePercent)}`}>
          ...
          <div className="bg-[#25262b] rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-xl font-bold text-white">{metrics?.bounceRate.value || 0}%</span>
              {metrics?.bounceRate.changePercent !== undefined && (
                <span className={`text-xs flex items-center gap-0.5 ${getTrendColor(metrics.bounceRate.changePercent, true)}`}>
